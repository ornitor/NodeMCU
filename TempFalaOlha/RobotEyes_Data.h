...
const RobotEyes::animFrame_t RobotEyes::seqBlink[] PROGMEM =
{
  { { 0, 0 }, FRAME_TIME/2 },
  { { 1, 1 }, FRAME_TIME/2 },
  { { 2, 2 }, FRAME_TIME/2 },
...
const RobotEyes::animFrame_t RobotEyes::seqWink[] PROGMEM =
{
  { { 0, 0 }, FRAME_TIME/2 },
  { { 1, 0 }, FRAME_TIME/2 },
  { { 2, 0 }, FRAME_TIME/2 },
...
const RobotEyes::animFrame_t RobotEyes::seqRight[] PROGMEM =
{
  { { 0, 0 }, FRAME_TIME },
  { { 6, 6 }, FRAME_TIME },
  { { 7, 7 }, FRAME_TIME * 5 },
...
const RobotEyes::animFrame_t RobotEyes::seqLeft[] PROGMEM =
{
  { { 0, 0 }, FRAME_TIME },
  { { 8, 8 }, FRAME_TIME },
  { { 9, 9 }, FRAME_TIME * 5 },
...
const RobotEyes::animFrame_t RobotEyes::seqUp[] PROGMEM =
{
  { { 00, 00 }, FRAME_TIME },
  { { 11, 11 }, FRAME_TIME },
  { { 12, 12 }, FRAME_TIME },
...
const RobotEyes::animFrame_t RobotEyes::seqDown[] PROGMEM =
{
  { { 00, 00 }, FRAME_TIME },
  { { 14, 14 }, FRAME_TIME },
  { { 15, 15 }, FRAME_TIME },
...
const RobotEyes::animFrame_t RobotEyes::seqAngry[] PROGMEM =
{
  { { 00, 00 }, FRAME_TIME },
  { { 22, 17 }, FRAME_TIME },
  { { 23, 18 }, FRAME_TIME },
...
const RobotEyes::animFrame_t RobotEyes::seqSad[] PROGMEM =
{
  { { 00, 00 }, FRAME_TIME },
  { { 32, 27 }, FRAME_TIME },
  { { 33, 28 }, FRAME_TIME },
...
const RobotEyes::animFrame_t RobotEyes::seqEvil[] PROGMEM =
{
  { { 00, 00 }, FRAME_TIME },
  { { 39, 37 }, FRAME_TIME },
  { { 40, 38 }, 2000 },
...
const RobotEyes::animFrame_t RobotEyes::seqEvil2[] PROGMEM =
{
  { { 00, 00 }, FRAME_TIME },
  { { 54, 17 }, FRAME_TIME },
  { { 55, 18 }, FRAME_TIME },
...
const RobotEyes::animFrame_t RobotEyes::seqSquint[] PROGMEM =
{
  { { 00, 00 }, FRAME_TIME },
  { { 54, 54 }, FRAME_TIME },
  { { 55, 55 }, FRAME_TIME },
...
const RobotEyes::animFrame_t RobotEyes::seqDead[] PROGMEM =
{
  { { 52, 52 }, FRAME_TIME * 4 },
  { { 53, 53 }, FRAME_TIME * 4 },
  { { 52, 52 }, FRAME_TIME * 2 },
...
const RobotEyes::animFrame_t RobotEyes::seqScanLeftRight[] PROGMEM =
{
  { { 41, 41 }, FRAME_TIME * 2 },
  { { 42, 42 }, FRAME_TIME },
  { { 43, 43 }, FRAME_TIME },
...
const RobotEyes::animFrame_t RobotEyes::seqScanUpDown[] PROGMEM =
{
  { { 46, 46 }, FRAME_TIME * 2 },
  { { 47, 47 }, FRAME_TIME },
  { { 48, 48 }, FRAME_TIME },
...
const RobotEyes::animTable_t RobotEyes::lookupTable[] PROGMEM =
{
  { RobotEyes::E_NEUTRAL, RobotEyes::seqBlink, 1 }, // special case, fixed neutral stare
  { RobotEyes::E_BLINK, RobotEyes::seqBlink, ARRAY_SIZE(RobotEyes::seqBlink) },
  { RobotEyes::E_WINK, RobotEyes::seqWink, ARRAY_SIZE(RobotEyes::seqWink) },
  { RobotEyes::E_LOOK_L, RobotEyes::seqLeft, ARRAY_SIZE(RobotEyes::seqLeft) },
  { RobotEyes::E_LOOK_R, RobotEyes::seqRight, ARRAY_SIZE(RobotEyes::seqRight) },
  { RobotEyes::E_LOOK_U, RobotEyes::seqUp, ARRAY_SIZE(RobotEyes::seqUp) },
  { RobotEyes::E_LOOK_D, RobotEyes::seqDown, ARRAY_SIZE(RobotEyes::seqDown) },
  { RobotEyes::E_ANGRY, RobotEyes::seqAngry, ARRAY_SIZE(RobotEyes::seqAngry) },
  { RobotEyes::E_SAD, RobotEyes::seqSad, ARRAY_SIZE(RobotEyes::seqSad) },
  { RobotEyes::E_EVIL, RobotEyes::seqEvil, ARRAY_SIZE(RobotEyes::seqEvil) },
  { RobotEyes::E_EVIL2, RobotEyes::seqEvil2, ARRAY_SIZE(RobotEyes::seqEvil2) },
  { RobotEyes::E_SQUINT, RobotEyes::seqSquint, ARRAY_SIZE(RobotEyes::seqSquint) },
  { RobotEyes::E_DEAD, RobotEyes::seqDead, ARRAY_SIZE(RobotEyes::seqDead) },
  { RobotEyes::E_SCAN_LR, RobotEyes::seqScanLeftRight, ARRAY_SIZE(RobotEyes::seqScanLeftRight) },
  { RobotEyes::E_SCAN_UD, RobotEyes::seqScanUpDown, ARRAY_SIZE(RobotEyes::seqScanUpDown) },
};
