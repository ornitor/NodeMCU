...
void RobotEyes::drawEyes(uint8_t L, uint8_t R)
...
#if DEBUG
void RobotEyes::dumpSequence(const animFrame_t* pBuf, uint8_t numElements)
...
uint8_t RobotEyes::loadSequence(emotion_t e)
...
void RobotEyes::loadFrame(animFrame_t* pBuf)
...
void RobotEyes::showText(bool bInit)
...
void RobotEyes::begin(MD_MAX72XX *M, uint8_t moduleStart)
...
bool RobotEyes::runAnimation(void)
// Animate the eyes
